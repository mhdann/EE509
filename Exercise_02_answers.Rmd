...
------------ | ------ | ----------
5            | 5      | `r sigma_beta(5,5)` 
1            | 1      | `r sigma_beta(1,1)` 
0.2          | 0.2    | `r sigma_beta(0.2,0.2)` 
...
------------ | ------ | ------------------------ | -------------------
6            | 6      | `r mu_beta(6,6)`         | `r median_beta(6,6)`
6            | 4      | `r mu_beta(6,4)`         | `r median_beta(6,4)`
6            | 2      | `r mu_beta(6,2)`         | `r median_beta(6,2)`
6            | 1.25   | `r mu_beta(6,1.25)`      | `r median_beta(6,1.25)`
6            | 1      | `r mu_beta(6,1)`         | `r median_beta(6,1)`
6            | 0.25   | `r mu_beta(6,0.25)`      | `r median_beta(6,0.25)`
...
------------ | ------------------ | ----------
rlnorm(x,0)  | `r mean_dlnorm(0)` | `r gm_mean_dlnorm(0)`
rlnorm(x,1)  | `r mean_dlnorm(1)` | `r gm_mean_dlnorm(1)`
rlnorm(x,2)  | `r mean_dlnorm(2)` | `r gm_mean_dlnorm(2)`
...
**A:** Provided the sample size is large, the normal can be used to very closely approximate the Poisson or Binomial distributions given an appropriate choice of variance. In otherwords, the Poisson and Binomial distributions are normal under large sample sizes (and in the Poisson case, large mean, $\lambda$).
...
------------ | ------ | -------------------
1            | 0.5      | `r mu_binom(1,0.5)`
2            | 0.5      | `r mu_binom(2,0.5)`
3            | 0.5      | `r mu_binom(3,0.5)`
5            | 0.5      | `r mu_binom(5,0.5)`
10           | 0.5      | `r mu_binom(10,0.5)`
